                        ...
                        <div class="col-12 col-lg-7">
                            <div class="product-info-section p-3">
                                ...
                                <div class="d-flex align-items-center mt-3 gap-2">
                                    <h5 class="mb-0 text-decoration-line-through text-light-3" id="price">VNĐ {{$product->selling_price}}</h5>
                                    <h4 class="mb-0" id="dprice">VNĐ {{$product->discount_price}}</h4>
                                </div>
                                <div class="mt-3">
                                    <h6>Discription :</h6>
                                ...
                                <div class="d-flex gap-2 mt-3">
                                    ...
                                    <button type="submit" class="btn btn-white btn-ecomm" onclick="addToCart()"> <i class="bx bxs-cart-add"></i>Thêm vào giỏ</button>
                                    <a class="btn btn-light btn-ecomm" id="{{$product->id}}" onclick="addToWishlist(this.id)"><i class="bx bx-heart"></i>Thêm vào yêu thích</a>
                                </div>
                                <br>
