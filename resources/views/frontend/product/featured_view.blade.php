    ...
    <section class="py-3 border-bottom border-top d-none d-md-flex bg-light">
        <div class="container">
            <div class="page-breadcrumb d-flex align-items-center">
                <h3 class="breadcrumb-title pe-3">Sản Phẩm Nổi Bật</h3>
            </div>
        </div>
    </section>
    <!--end breadcrumb-->
                                        ...
                                        <div class="card-body">
                                            <div class="product-info">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="mb-1 product-price"> <span class="me-1 text-decoration-line-through">VNĐ {{$row->selling_price}}</span>
                                                        <span class="fs-5">VNĐ {{$row->discount_price}}</span>
                                                    </div>
                                                ...
                                                <div class="product-action mt-2">
                                                    <div class="d-grid gap-2">
                                                        <a href="javascript:;" class="btn btn-dark btn-ecomm" data-bs-toggle="modal" data-bs-target="#exampleModal" id="{{$row->id}}" onclick="productView(this.id)"> <i class="bx bxs-cart-add"></i>Thêm vào giỏ</a>
                                                        <a href="javascript:;" class="btn btn-light btn-ecomm" id="{{$row->id}}" onclick="addToWishlist(this.id)"><i class='bx bx-heart'></i>Thêm vào yêu thích</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
