    ...
    <div class="top-menu border-bottom">
        <div class="container">
            <nav class="navbar navbar-expand" style="color: black;">
                ...
                @endphp
                <div class="shiping-title text-uppercase font-13 d-none d-sm-flex">TINYTOTS !!! THẾ GIỚI TRẺ EM
                    {{-- {{$setting->company_name}} --}}
                    </div>
                <ul class=" navbar-nav ms-auto d-none d-lg-flex">
                    <li class="nav-item"> <a class="nav-link" href="" data-bs-toggle="modal" data-bs-target="#ordertracking" style="color: black;">Theo Dõi Đơn Hàng</a>
                    </li>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{route('blog.view')}}" style="color: black;">Tin tức</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    ...
                    @auth
                    <li class="nav-item"> <a class="nav-link" href="{{route('dashboard')}}" style="color: black;">Tài khoản</a>
                    </li>
                    @else
                    <li class="nav-item"> <a class="nav-link" href="{{route('login')}}" style="color: black;">Đăng nhập/Đăng ký</a>
                    </li>
                    @endauth
                </ul>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col col-md order-4 order-md-2">
                        <form method="post" action="{{ route('product.search') }}">
                            ...
                            <div class="input-group flex-nowrap px-xl-4">
                                <input type="text" onfocus="search_result_show()" onblur="search_result_hide()" name="search" id="search" class="form-control w-100" placeholder="Tìm Kiếm Sản Phẩm">
                    ...
                    <div class="col-4 col-md-auto order-3 d-none d-xl-flex align-items-center">
                        ...
                        <div class="ms-2">
                            <p class="mb-0 font-13">Gọi cho chúng tôi</p>
                            <h5 class="mb-0">0123456789
                                {{-- {{$setting->phone_one}} --}}
                            </h5>
                        </div>
                    </div>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('mycart') }}">
                                                <div class="cart-header">
                                                    <p class="cart-header-title mb-0"> <span id="cartQty"></span> Sản Phẩm</p>
                                            ...
                                            <div class="d-grid p-3 border-top"> <a href="{{route('checkout')}}" type="submit" class="btn btn-dark btn-ecomm">Thanh Toán</a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
        ...
        <div class="container">
            <nav id="navbar_main" class="mobile-offcanvas navbar navbar-expand-lg">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">Tài khoản <i class='bx bx-chevron-down'></i></a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{route('dashboard')}}">Thông tin</a>
                            </li>
                            <li><a class="dropdown-item" href="{{route('user.orders')}}">Đơn hàng</a>
                            </li>
                            <li><a class="dropdown-item" href="{{route('user.payment')}}">Phương thức thanh toán</a>
                            </li>
                            <li><a class="dropdown-item" href="{{route('user.profile')}}">Chi tiết người dùng</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('order.tracking')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <h6>Mã Đơn Hàng</h6>
                        <input type="text" name="code" required="" class="form-control" placeholder="Mã Code đơn hàng">
                    </div>
                    <button class="btn btn-info" type="submit" style="margin-left: 17px;">Kiểm tra</button>
                </form>
            </div>
        </div>
    </div>
