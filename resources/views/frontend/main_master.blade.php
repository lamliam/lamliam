...
<body>
    ...
    <div class="wrapper">
        ...
        <!--end footer section-->
        <!--start Xem nhanh product-->
        <!-- Modal -->
        <!--end Xem nhanh product-->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card" style="width: 10rem;">
                                <img src=" " class="card-img-top" alt="..." style="height: 240px; width: 200px;"
                                    id="pimage">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <ul class="list-group">
                                <li class="list-group-item">Giá sản phẩm: <strong class="text-danger">VNĐ <span
                                            id="pprice"></span></strong>
                                    <del id="oldprice">VNĐ </del>
                                </li>
                                ...
                                <li class="list-group-item">Loại : <strong id="pbrand"></strong> </li>
                                <li class="list-group-item">Tình trạng:
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="form-group text-center">
                                    ...
                                    <button type="submit" class="btn btn-primary mt-3" onclick="addToCart()">Thêm vào
                                        giỏ</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="product-info">
                                    ...
                                    <div class="product-action mt-2">
                                        ...
                                        <a href="javascript:;" class="btn btn-dark btn-ecomm" data-bs-toggle="modal" data-bs-target="#exampleModal" id="${value.product_id}" onclick="productView(this.id)"> <i class='bx bxs-cart-add'></i>Thêm vào giỏ</a>
