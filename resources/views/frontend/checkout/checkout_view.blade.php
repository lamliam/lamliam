    ...
    <section class="py-3 border-bottom border-top d-none d-md-flex bg-light">
        <div class="container">
            <div class="page-breadcrumb d-flex align-items-center">
                <h3 class="breadcrumb-title pe-3">Thanh Toán</h3>
                <div class="ms-auto">
                                ...
                                <div class="card-body">
                                    <div class="steps steps-light">
                                        <a class="step-item active" href="shop-cart.html">
                                            ...
                                            <div class="step-label"><i class='bx bx-cart'></i>Giỏ hàng</div>
                                        </a>
                                        <a class="step-item active current" href="checkout-details.html">
                                            <div class="step-progress"><span class="step-count">2</span>
                                            </div>
                                            <div class="step-label"><i class='bx bx-user-circle'></i>Chi tiết</div>
                                        </a>
                                    ...
                                    <div class="border p-3">
                                        ...
                                        <div class="form-body">
                                            <form class="row g-3" action="{{route('checkout.storedata')}}" method="POST">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="form-label">Mã Zip / Mã Bưu Điện</label>
                                                ...
                                                <div class="col-md-12">
                                                    <h6 class="mb-0 h5">Chọn phương thức thanh toán</h6>
                                                    <hr>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-grid"> <a href="{{ route('mycart') }}" class="btn btn-light btn-ecomm"><i class='bx bx-chevron-left'></i>Quay lại giỏ hàng</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="d-grid"> <button type="submit" class="btn btn-dark btn-ecomm">Thanh Toán<i class='bx bx-chevron-right'></i></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                            ...
                            <div class="card rounded-0">
                                <div class="card-body">
                                    ...
                                    <div class="card rounded-0 border bg-transparent shadow-none" id="coupanField">
                                        <div class="card-body">
                                            <p class="fs-5">Áp dụng mã giảm giá</p>
                                            <div class="input-group">
                                                <input type="text" class="form-control rounded-0" placeholder="Enter discount code" id="coupan_name">
                                                <button class="btn btn-dark btn-ecomm" type="button" onclick="applyCoupan()">Áp dụng giảm giá</button>
                                            </div>
                                        </div>
                                    </div>
                                    @endif
                                    <div class="card rounded-0 border bg-transparent shadow-none">
                                        <div class="card-body">
                                            <p class="fs-5">Thứ tự đơn hàng</p>
                                    ...
                                    <div class="card rounded-0 border bg-transparent mb-0 shadow-none">
                                        <div class="card-body">
                                            @if(Session::has('coupan'))
                                            <p class="mb-2">Tổng: <span class="float-end">${{$cartTotal}}</span>
                                            </p>
                                            <p class="mb-2">Phí vận chuyển: <span class="float-end">Miễn phí</span>
                                            </p>
                                            <p class="mb-2">Mã giảm giá: <span class="float-end">{{session()->get('coupan')['coupan_name']}}
                                                    ({{session()->get('coupan')['coupan_discount']}}%)
                                                </span>
                                            </p>
                                            <p class="mb-0">Giảm giá: <span class="float-end">VNĐ {{session()->get('coupan')['discount_amount']}}</span>
                                            </p>
                                            <div class="my-3 border-top"></div>
                                            <h5 class="mb-0">Tổng hóa đơn: <span class="float-end">VNĐ {{session()->get('coupan')['total_amount']}}</span></h5>

                                            @else
                                            <p class="mb-2">Tổng: <span class="float-end">VNĐ {{$cartTotal}}</span>
                                            </p>
                                            <p class="mb-2">Phí vận chuyển: <span class="float-end">Miễn phí</span>
                                            </p>
                                            <div class="my-3 border-top"></div>
                                            <h5 class="mb-0">Tổng hóa đơn: <span class="float-end">VNĐ {{$cartTotal}}</span></h5>
                                        </div>
                                        @endif
                                    </div>
                                    <br><br>
