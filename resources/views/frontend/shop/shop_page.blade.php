                            ...
                            <div class="card rounded-0 w-100">
                                <div class="card-body">
                                    <div class="align-items-center d-flex d-xl-none">
                                        <h6 class="text-uppercase mb-0">Lọc</h6>
                                    ...
                                    <div class="price-range">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <button type="button" class="btn btn-dark btn-sm text-uppercase rounded-0 font-13 fw-500">Lọc</button>
                                            <div class="ms-auto">
                                                <p class="mb-0">Price: VNĐ 200.000 - VNĐ 9.000.000</p>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                                ...
                                                @elseif ($avarage == 2 || $avarage < 3) <span class="fa fa-star checked"></span>
                                                    ...
                                                    <div class="product-action mt-2">
                                                        <div class="d-grid gap-2">
                                                            ...
                                                            <a href="javascript:;" class="btn btn-light btn-ecomm" data-bs-toggle="modal" data-bs-target="#QuickViewProduct"><i class="bx bx-zoom-in"></i>Xem nhanh</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
