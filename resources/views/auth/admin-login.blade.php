        ...
        <div class="login-box">
            <div class="white-box">
                <form class="form-horizontal form-material" id="loginform" method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('password.request') }}" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Quên Mật Khẩu</a>
                        </div>
                    </div>
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button type="submit" class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light"><i class="bx bxs-lock-open"></i>Đăng Nhập</button>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Bạn chưa có tài khoản? <a href="{{ route('register') }}l" class="text-primary m-l-5"><b>Đăng Ký</b></a></p>
                        </div>
                    </div>
                </form>
                <form class="form-horizontal" id="recoverform" action="{{route('update.change.password')}}">
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <h3>Gửi lại mật khẩu</h3>
                            <p class="text-muted">Đăng nhập Email và nhận hướng dẫn được gửi cho bạn! </p>
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-primary btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Khởi động lại</button>
                        </div>
                    </div>
                </form>
            </div>
