    ...
    <div class="scroll-sidebar">
            ...
            <div class="dropdown user-pro-body">
                <div class="profile-image">
                    ...
                    <ul class="dropdown-menu animated flipInY">
                        <li><a href="{{route('admin.profile')}}"><i class="fa fa-user"></i> Thông tin</a></li>
                        <li><a href="{{route('admin.change.password')}}"><i class="fa fa-inbox"></i> Đổi mật khẩu</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="javascript:void(0);"><i class="fa fa-cog"></i> Cài đặt </a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="{{route('admin.logout')}}"><i class="fa fa-power-off"></i> Đăng xuất</a></li>
                    </ul>
                </div>
                <p class="profile-text m-t-15 font-16"><a href="javascript:void(0);"> TinyTots</a></p>
            </div>
        </div>
        <nav class="sidebar-nav">
            <ul id="side-menu">
                ...
                <li>
                    <a class="waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="icon-grid fa-fw"></i> <span class="hide-menu">DANH MỤC</span></a>
                    <ul aria-expanded="false" class="collapse">
