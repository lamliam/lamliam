...
<div class="col-lg-8">
    <div class="white-box">
        ...
        <table class="tablesaw table-striped table-hover table-bordered table tablesaw-columntoggle" data-tablesaw-mode="columntoggle" id="table-7981">
            <thead>
                <tr>
                    <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="3" class="tablesaw-priority-3">Slider Ảnh</th>
                    <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-priority="persist">Slider Tiêu Đề</th>
                    <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-priority="persist">Slider Miêu Tả</th>
                    <th scope="col" data-tablesaw-sortable-col="" data-tablesaw-priority="persist">Slider Trạng Thái</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="title">
                        @if($item->title == NULL)
                        <span class="badge badge-pill badge-info"> Không tiêu đề </span>
                        @else
                        {{$item->title}}
                        @endif
                    </td>
                    <td class="title">
                        ...
                        <span class="badge badge-pill badge-info"> Không miêu tả </span>
                        @else
                        {{$item->description}}
                        @endif
                    </td>
