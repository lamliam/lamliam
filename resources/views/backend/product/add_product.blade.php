                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label class="control-label">Select SubCategory <span
                                                        class="text-danger">*</span></label>
                                                <select name="subcategory_id" class="form-control" required=""
                                                    onchange="getSubSubSelect(this)">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label class="control-label">Select SubSubCategory <span
                                                        class="text-danger">*</span></label>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label class="control-label">Select Brand <span
                                                        class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Product Quantity <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Product Color <span
                                                    class="text-danger">*</span></label>
                                            <div class="tags-default">
                                                <input type="text" data-role="tagsinput" name="product_color"
                                                    class="form-control" required="" value="red,blue,black">
                                            </div>
                                            @error('product_color')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Product Tags <span
                                                    class="text-danger">*</span></label>
                                            <div class="tags-default">
                                                <input type="text" data-role="tagsinput" name="product_tags"
                                                    class="form-control" required="" value="jQuery,Script,Net">
                                            </div>
                                            @error('product_tags')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Product Size <span
                                                    class="text-danger">*</span></label>
                                            <div class="tags-default">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Product Selling Price <span
                                                    class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="white-box">
                                                <label class="control-label">Product Thumbnail <span
                                                        class="text-danger">*</span></label>
                                                <input type="file" class="form-control" data-max-file-size="2M"
                                                    name="product_thumbnail" required="" onchange="mainThumbUrl(this)" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="white-box">
                                                <label class="control-label">Product Images <span
                                                        class="text-danger">*</span></label>
